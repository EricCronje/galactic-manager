    ...
    public class UnitTest1
    {
        ...
        public void ScenarioValidAddItemSearchView()
        {
            ...
            for (int i = 0; i < Entity.Length; i++)
            {
                ...
                #region Set the variables needed  fro the test.
                ...
                var ResultsPath = $"{CodeGenHelper.WorkingFolder}\\TestResults\\{CodeGenHelper.CurrentGuid}\\{CodeGenHelper.CurrentGuid}_{Entity[i]}";
                ...
                try
                {
                    ...
                    {
                        var ResultsPathInternal = $"{ResultsPath}_TR{j + 1}";
