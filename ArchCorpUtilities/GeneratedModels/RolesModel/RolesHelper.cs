...
using ArchCorpUtilities.Models.RolesModel.Roles;
...
namespace ArchCorpUtilities.GeneratedModels.RolesModel
{
    public class RolesHelper : IHelper<Roles>, IDisposable
	{
       ...
       public RolesHelper(string? sessionID)
        ...
        private List<Roles>? MockData()
			{
            if (Items == null || Items.Count == 0)
                Items = [];

            Items.Add(new Roles("Alpha-Roles", 1));
            Items.Add(new Roles("Beta-Roles", 2));
            Items.Add(new Roles("Charlie-Roles", 3));
            Items.Add(new Roles("Delta-Roles", 3));
            Items.Add(new Roles("Echo-Roles", 3));
            Items.Add(new Roles("Foxtrot-Roles", 3));
            Items.Add(new Roles("Golf-Roles", 3));
            Items.Add(new Roles("Hotel-Roles", 3));
            return Items;
			}
